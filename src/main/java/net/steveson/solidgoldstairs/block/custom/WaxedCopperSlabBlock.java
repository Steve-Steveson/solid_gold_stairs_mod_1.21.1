...
public class WaxedCopperSlabBlock extends SlabBlock {
    private final WeatheringCopper.WeatherState weatherState;

    public WaxedCopperSlabBlock(WeatheringCopper.WeatherState weatherState, Properties properties) {
        super(properties);
    ...
    public Optional<Block> getUnwaxedBlock() {
        return switch (this.weatherState) {
            case UNAFFECTED -> Optional.of(ModBlocks.COPPER_SLAB.get());
            case EXPOSED -> Optional.of(ModBlocks.EXPOSED_COPPER_SLAB.get());
            case WEATHERED -> Optional.of(ModBlocks.WEATHERED_COPPER_SLAB.get());
            case OXIDIZED -> Optional.of(ModBlocks.OXIDIZED_COPPER_SLAB.get());
        };
    }
