...
public class UncutWeatheringCopperSlabBlock extends SlabBlock implements WeatheringCopper, SteveHasWeatheringCopper {
    ...
    public UncutWeatheringCopperSlabBlock(WeatherState weatherState, Properties properties) {
        super(properties);
    ...
    public Optional<Block> getWaxedBlock() {
        return switch (this.weatherState) {
            case UNAFFECTED -> Optional.of(ModBlocks.WAXED_COPPER_SLAB.get());
            case EXPOSED -> Optional.of(ModBlocks.WAXED_EXPOSED_COPPER_SLAB.get());
            case WEATHERED -> Optional.of(ModBlocks.WAXED_WEATHERED_COPPER_SLAB.get());
            case OXIDIZED -> Optional.of(ModBlocks.WAXED_OXIDIZED_COPPER_SLAB.get());
        };
    }
